...
WebUI.verifyElementVisible(findTestObject('Page Checkout Overview/Label Description'))

WebUI.verifyElementVisible(findTestObject('Page Checkout Overview/Label Harga'))

WebUI.verifyElementVisible(findTestObject('Page Checkout Overview/Label QTY'))

WebUI.verifyElementVisible(findTestObject('Page Checkout Overview/Title Page Checkout Overview'))

WebUI.verifyElementVisible(findTestObject('Page Checkout Overview/Title Product'))
